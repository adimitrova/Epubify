...
class Dropbox(object):
    def __init__(self, **kwargs):
        ...
        self.token = read_json(file_path=self.cred_filename, key_name="dropbox").get("token")
    ...
    def save_book(self, book):
        ...
        try:
            ...
            raise Exception(
                "There was a problem uploading file %s to Dropbox. >> ERR >> %s" % (self.output_file_path, err)
            )
